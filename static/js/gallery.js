...
function imageFound(im, dv) {
  return function () {
    ...
    let h = im.height;
    let w = im.width;
    // dv.setAttribute("style", "height: 100vh; width: 100vw; text-align: center; padding: 2vh 0; object-fit: scale-down");
    if (h > w) {
      dv.setAttribute("style", "height: 100vh; text-align: center; padding: 2vh 0;");
      im.setAttribute("style", "height: 100%; max-width: 100%; width: auto; object-fit: contain");
    } else {
      dv.setAttribute("style", "width: 100vw; text-align: center; padding: 2vh 0;");
      im.setAttribute("style", "width: 100%; max-height: 100%; height: auto; object-fit: contain");
    }
